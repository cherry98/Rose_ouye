...
public class SobotEvaluateDialog extends SobotActionSheet {
    ...
    protected void initView() {
        ...
        LinearLayout sobot_negativeButton = (LinearLayout) findViewById(getResId("sobot_negativeButton"));
        ...
        sobot_readiogroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                if (checkedId == getResId("sobot_btn_ok_robot")) {
                    sobot_btn_ok_robot.setTextColor(Color.parseColor("#FFFFFFFF"));
                    sobot_btn_no_robot.setTextColor(Color.parseColor("#FFA0A0A0"));
                } else if (checkedId == getResId("sobot_btn_no_robot")) {
                    sobot_btn_no_robot.setTextColor(Color.parseColor("#FFFFFFFF"));
                    sobot_btn_ok_robot.setTextColor(Color.parseColor("#FFA0A0A0"));
                }
