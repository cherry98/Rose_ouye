...
package com.sinozpf.wheelview.widget;
...
import com.sinozpf.wheelview.R;
import com.sinozpf.wheelview.widget.adapters.WheelViewAdapter;
    ...
    private boolean addViewItem(int index, boolean first) {
        ...
        if (view != null) {
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
                    (int) getContext().getResources().getDimension(R.dimen.height));
            if (first) {
                itemsLayout.addView(view, 0, lp);
            } else {
                itemsLayout.addView(view, lp);
            }
