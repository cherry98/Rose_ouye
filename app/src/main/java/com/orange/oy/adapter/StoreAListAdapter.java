...
public class StoreAListAdapter extends BaseAdapter {
    ...
    public StoreAListAdapter(Context context, ArrayList<StoreListInfo> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final StoreListInfo storeListInfo = list.get(position);

        viewHolder.tv_name.setText(storeListInfo.getStore_name() + "(" + storeListInfo.getStore_num() + ")");
        viewHolder.tv_address.setText(storeListInfo.getStore_url());
