            ...
            switch (msg.what) {
                ...
                case MSG_REQUEST: // 收到请求
                    ...
                    if (msg.obj != null && msg.obj instanceof ImageRef) {
                        ...
                        BitmapFactory.decodeFile(url, opt1);
                        int bitmapSize1 = opt1.outHeight * opt1.outWidth * 4;
                        opt1.inSampleSize = bitmapSize1 / (1000 * 2000);
                        opt1.inJustDecodeBounds = false;
                        tBitmap = BitmapFactory.decodeFile(url, opt1);
