...
package com.orange.oy.clusterutil.clustering.view;
...
import com.orange.oy.clusterutil.MarkerManager;
...
import com.orange.oy.clusterutil.projection.SphericalMercatorProjection;
import com.orange.oy.clusterutil.ui.IconGenerator;
...
import static com.orange.oy.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.orange.oy.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private LayerDrawable makeClusterBackground() {
        ...
        int strokeWidth = (int) (mDensity);
        background.setLayerInset(1, strokeWidth, strokeWidth, strokeWidth, strokeWidth);
        return background;
    }

    private com.orange.oy.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        com.orange.oy.clusterutil.ui.SquareTextView squareTextView =
                new com.orange.oy.clusterutil.ui.SquareTextView(context);
        ViewGroup.LayoutParams layoutParams = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        squareTextView.setLayoutParams(layoutParams);
        squareTextView.setId(R.id.text);
        int twelveDpi = (int) (mDensity);
    ...
    protected void onBeforeClusterRendered(Cluster<T> cluster, MarkerOptions markerOptions) {
        ...
        if (descriptor == null) {
            descriptor = mIconGenerator.makeIcon(getClusterText(bucket));
