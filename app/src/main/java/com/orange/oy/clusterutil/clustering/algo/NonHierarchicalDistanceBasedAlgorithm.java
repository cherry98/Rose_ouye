...
package com.orange.oy.clusterutil.clustering.algo;
...
//        throw new UnsupportedOperationException("NonHierarchicalDistanceBasedAlgorithm.remove not implemented");
        synchronized (mQuadTree) {
            for (QuadItem<T> quadItem : mItems) {
                if (quadItem.mClusterItem.hashCode() == item.hashCode()) {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.orange.oy.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.orange.oy.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.orange.oy.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.orange.oy.clusterutil.clustering.algo
