...
public class IconGenerator {
     ...
     */
    public BitmapDescriptor makeIcon(String text) {
        if (mTextView != null) {
            mTextView.setText(text);
//            int index = Integer.parseInt(text);
//            if (index >= 10) {
//                mTextView.setBackgroundColor(mContext.getResources().getColor(R.color.background3));
//            } else if (index < 10 && index >= 5) {
//                mTextView.setBackgroundColor(mContext.getResources().getColor(R.color.background2));
//            } else if (index < 5) {
//                mTextView.setBackgroundColor(mContext.getResources().getColor(R.color.background1));
//            }
        }

//        return makeIcon();
        return BitmapDescriptorFactory.fromView(mContainer);
    }
