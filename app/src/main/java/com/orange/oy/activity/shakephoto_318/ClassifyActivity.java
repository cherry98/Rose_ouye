...
import com.orange.oy.adapter.SelectText2Adapter;
 ...
 * V3.18  甩图相册------- 活动主题
 */
public class ClassifyActivity extends BaseActivity implements AppTitle.OnBackClickForAppTitle, AdapterView.OnItemClickListener {
    ...
    private void initNetwork() {
        themeInfo = new NetworkConnection(this) {
            ...
            public Map<String, String> getNetworkParams() {
                ...
                params.put("usermobile", AppInfo.getName(ClassifyActivity.this));
    ...
    private SelectText2Adapter selectTextAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectTextAdapter = new SelectText2Adapter(this, list);
            ...
            public void onResponse(String s) {
                ...
                try {
                    ...
                    if (jsonObject.getInt("code") == 200) {
                        ...
                        Tools.showToast(ClassifyActivity.this, jsonObject.getString("msg"));
                    }
                } catch (JSONException e) {
                    Tools.showToast(ClassifyActivity.this, getResources().getString(R.string.network_error));
                }
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError volleyError) {
                Tools.showToast(ClassifyActivity.this, getResources().getString(R.string.network_volleyerror));
                themeclassify_listview.onRefreshComplete();
            }
        });
    }
