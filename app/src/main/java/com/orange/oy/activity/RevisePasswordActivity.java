 ...
 * 修改密码
 */
public class RevisePasswordActivity extends BaseActivity implements AppTitle.OnBackClickForAppTitle, View
        .OnClickListener {
    private AppTitle forgetpw_title;

    private void initTitle() {
        forgetpw_title = (AppTitle) findViewById(R.id.forgetpw_title);
        forgetpw_title.settingName(getResources().getString(R.string.revisepw));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgetpw_moblie.setEnabled(false);
        forgetpw_moblie.setHint(getResources().getString(R.string.revisepw_hint));
        forgetpw_moblie.setText(AppInfo.getName(this));
        ...
        sendData.sendPostRequest(Urls.Findpassword, new Response.Listener<String>() {
            public void onResponse(String s) {
                ...
                try {
                    ...
                    if (code == 200) {
                        Tools.showToast(RevisePasswordActivity.this, getResources().getString(R.string.forgetpw_toast));
                        setResult(AppInfo.RevisePasswordResultCode);
                        baseFinish();
                    } else {
                        Tools.showToast(RevisePasswordActivity.this, jsonObject.getString("msg"));
                    }
                } catch (JSONException e) {
                    Tools.showToast(RevisePasswordActivity.this, getResources().getString(R.string.network_error));
                }
            }
        }, new Response.ErrorListener() {
            public void onErrorResponse(VolleyError volleyError) {
                CustomProgressDialog.Dissmiss();
                Tools.showToast(RevisePasswordActivity.this, getResources().getString(R.string.network_volleyerror));
            }
        }, null);
    }
