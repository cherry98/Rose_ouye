...
public class PayCaseActivity extends BaseActivity implements AppTitle.OnBackClickForAppTitle, CompoundButton.OnCheckedChangeListener {
        ...
        findViewById(R.id.myaccount_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!cb_moneyEnough.isChecked() && !cb_zhifubao.isChecked()) {
                    Tools.showToast(PayCaseActivity.this, "请选择支付方式");
                    return;
                }
                //选择哪种方式
    ...
    public void onStop() {
        ...
        if (sponsorshipPay != null) {
            sponsorshipPay.stop(Urls.ProjectPayConfirm);
        }
    }
    ...
    private void sponsorshipPay() {
        sponsorshipPay.sendPostRequest(Urls.ProjectPayConfirm, new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if (jsonObject.getInt("code") == 200) {
                        if (type.equals("1")) {
                            ...
                            Intent intent = new Intent(PayCaseActivity.this, PutInTask2Activity.class);
