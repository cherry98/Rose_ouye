 ...
 * 常去地点
 */
public class OftenGotoPlaceActivity extends BaseActivity implements AppTitle.OnBackClickForAppTitle, TagsView.OnOtherClickListener, TagsView.OnClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teamSpecialtyView.setOnOtherClickListener(this, "请输入常去地点名称，最多10个字", 3);
        teamSpecialtyView.setOnClick(this);
        teamSpecialtyView.notifyDataSetChanged();
    }

    private TagsView.OnRemoveClickListener onRemoveClickListener = new TagsView.OnRemoveClickListener() {
        public void remove() {
        }
    };
    ...
    public void onBack() {
        ...
        intent.putExtra("oftengotoPlace", text.substring(0, text.length() - 1));
        setResult(AppInfo.REQUEST_CODE_OftenGoTOPlace, intent);
        baseFinish();
    }
