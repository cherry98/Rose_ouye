...
import com.orange.oy.allinterface.Pullable;
...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private OnRetreshComplentListener completeListener;
    private float downX;
    private float distanceX;
    private float distanceY;

    public void setCompleteListener(OnRetreshComplentListener completeListener) {
            ...
            switch (refreshResult) {
                case SUCCEED:
                    ...
                    refreshStateImageView
                            .setBackgroundResource(R.color.app_background2);
                    break;
                case FAIL:
                default:
                    // 刷新失败
        ...
        if (loadingView != null) {
            ...
            switch (refreshResult) {
                case SUCCEED:
                    ...
                    loadStateImageView.setBackgroundResource(R.color.app_background2);
                    break;
                case FAIL:
                default:
                    // 加载失败
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            case INIT:
                ...
                refreshStateTextView.setText(R.string.listview_down);
                pullView.clearAnimation();
            ...
            case RELEASE_TO_REFRESH:
                // 释放刷新状态
                refreshStateTextView.setText(R.string.listview_down2);
...
//                refreshingView.startAnimation(refreshingAnimation);
                refreshStateTextView.setText(R.string.listview_refush);
                break;
    ...
    private void initView() {
        ...
        refreshingView = refreshView.findViewById(R.id.refresh_progress);
    ...
    public interface OnRetreshComplentListener {
        void OnComplete();
    }
}
