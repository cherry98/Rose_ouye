...
//		setBackgroundColor(mBgColor);
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mState == STATE_TRANSFORM_IN || mState == STATE_TRANSFORM_OUT) {
			...
			if(mTransformStart){
				/*DebugLog.d("Dean", "mTransfrom.startScale:"+mTransfrom.startScale);
				DebugLog.d("Dean", "mTransfrom.startScale:"+mTransfrom.endScale);
				DebugLog.d("Dean", "mTransfrom.scale:"+mTransfrom.scale);
				DebugLog.d("Dean", "mTransfrom.startRect:"+mTransfrom.startRect.toString());
				DebugLog.d("Dean", "mTransfrom.endRect:"+mTransfrom.endRect.toString());
				DebugLog.d("Dean", "mTransfrom.rect:"+mTransfrom.rect.toString());*/
			}
