...
import com.orange.oy.dialog.DiscussListDialog;
...
import static com.orange.oy.service.RecordService.getIntent;


/**
 * V3.18查看广告大图 ------评论列表dialog   V3.21修改为view
 */
public class DiscussListView extends LinearLayout implements DiscussListAdapter.OrlikeClickListener, View.OnClickListener {
    ...
    private String total_num, content, is_advertisement;
    ...
    public void SetData(String fi_id1, String sai_id1, String is_advertisement1) {
        fi_id = fi_id1;
        sai_id = sai_id1;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_dismiss: {
                ...
                DiscussListDialog.dissmisDialog();
            }
            break;
            // 评论发送按钮
            case R.id.tv_sure: {
