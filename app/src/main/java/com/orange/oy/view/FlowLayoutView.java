...
/**
 * Created by xiedongyan on 2017/11/24.
 * 添加标签
 */
...
public class FlowLayoutView extends ViewGroup {
    ...
    public FlowLayoutView(Context context, AttributeSet attrs) {
        ...
        TypedArray attrArray = context.obtainStyledAttributes(attrs, R.styleable.FlowLayoutView);
        if (attrArray != null) {
            childHorizontalSpace = attrArray.getDimensionPixelSize(R.styleable.FlowLayoutView_width_space, 0);
            childVerticalSpace = attrArray.getDimensionPixelSize(R.styleable.FlowLayoutView_height_space, 0);
            attrArray.recycle();
        }
