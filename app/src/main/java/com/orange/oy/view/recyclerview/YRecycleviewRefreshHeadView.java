package com.orange.oy.view.recyclerview;
...
public class YRecycleviewRefreshHeadView extends LinearLayout {
    ...
    private View pb_y_recycleview_head_refresh_progressbar;
    ...
    private void initView(Context context) {
        ...
        //正在刷新的进度条
        pb_y_recycleview_head_refresh_progressbar = findViewById(R.id.pb_y_recycleview_head_refresh_progressbar);
        //定义一个向上旋转动画
    ...
    public void setState(int status) {
        ...
        switch (status) {
            case STATE_NORMAL:
                ...
                tv_y_recycleview_head_refresh_status.setText(getResources().getString(R.string.listview_down));
                break;
            ...
            case STATE_RELEASE_TO_REFRESH:
                ...
                if (mStatus != STATE_RELEASE_TO_REFRESH) {
                    ...
                    tv_y_recycleview_head_refresh_status.setText(getResources().getString(R.string.listview_down2));
                }
                break;
            case STATE_REFRESHING:
                tv_y_recycleview_head_refresh_status.setText(getResources().getString(R.string.listview_refush));
                break;
            case STATE_DONE:
