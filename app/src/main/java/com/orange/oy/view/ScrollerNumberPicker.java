...
public class ScrollerNumberPicker extends View {
    ...
    private synchronized void drawList(Canvas canvas) {
        ...
        try {
            ...
            Log.e("ScrollerNumberPicker", e.getMessage());
        }
    }
    ...
    private void drawLine(Canvas canvas) {
        ...
        canvas.drawLine(0, controlHeight / 2 - unitHeight / 2 + 2, controlWidth, controlHeight / 2 - unitHeight / 2 +
                2, linePaint);
        canvas.drawLine(0, controlHeight / 2 + unitHeight / 2 - 2, controlWidth, controlHeight / 2 + unitHeight / 2 -
                2, linePaint);
    }
    ...
    private void drawMask(Canvas canvas) {
        ...
        LinearGradient lg2 = new LinearGradient(0, controlHeight - maskHight, 0, controlHeight, 0x00f2f2f2,
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            if (isSelected()) {
                ...
                // 计算当前字体大小
                float textSize = (float) normalFont + ((float) (selectedFont - normalFont) * (1.0f - (float)
                        moveToSelect / (float) unitHeight));
            ...
            // 绘制内容
            canvas.drawText(itemText, x + controlWidth / 2 - textRect.width() / 2, y + move + unitHeight / 2 +
        ...
        public boolean isSelected() {
            if ((y + move) >= controlHeight / 2 - unitHeight / 2 + 2 && (y + move) <= controlHeight / 2 + unitHeight
                    / 2 - 2)
                return true;
            if ((y + move + unitHeight) >= controlHeight / 2 - unitHeight / 2 + 2 && (y + move + unitHeight) <=
                    controlHeight / 2 + unitHeight / 2 - 2)
                return true;
            if ((y + move) <= controlHeight / 2 - unitHeight / 2 + 2 && (y + move + unitHeight) >= controlHeight / 2
                    + unitHeight / 2 - 2)
                return true;
            return false;
        }
